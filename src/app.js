...
// import sequelize from "./storage/psql.sequelize"
...
class App {
  ...
  constructor() {
    ...
    this.app.use("/videos", express.static("videos"));
  ...
  _setCors() {
    this.app.use(
      // cors({
      //   // origin: ['http://192.168.0.108:3000','http://192.168.0.108:3001','http://192.168.0.108:3002','http://192.168.0.108:3456','http://192.168.0.108:4567'],
      //   origin:['*'],
